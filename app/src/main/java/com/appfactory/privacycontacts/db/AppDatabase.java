...
@Database(entities = {ContactEntity.class}, version = 1, exportSchema = false) //entities is the name of the class followed by .class. Version represent the version of database.
